...
<section>
	<!--表单-->
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
			...
			<el-form-item label="按网点">
			<el-select v-model="filters.netpoint" placeholder="请选择区域">
				<el-option label="网点一" value="shanghai"></el-option>
				<el-option label="网点二" value="beijing"></el-option>
			</el-select>
		</el-form-item>
				<!--<el-form-item>
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="beginTime" label="开始时间" width="250" sortable>
			</el-table-column>
			<el-table-column prop="endTime" label="结束时间" width="250" sortable>
			</el-table-column>
			<el-table-column prop="netPoint" label="网点" width="260" sortable>
			</el-table-column>
			<el-table-column prop="pointPerson" label="网点负责人" width="150" sortable>
			</el-table-column>
			<el-table-column prop="checkPerson" label="检查负责人" width="150" sortable>
			</el-table-column>
