...
<section>
	<!--表单-->
		...
		<el-table :data="users" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;" align="left">
			...
			<el-table-column prop="contradictionDes" label=矛盾类型" width="280" sortable>
			</el-table-column>
			<el-table-column prop="pointPerson" label="当事人姓名" width="150" sortable>
			</el-table-column>
			<el-table-column prop="checkPerson" label="当事人电话" min-width="160" sortable>
			</el-table-column>
			<el-table-column prop="submitPerson" label="提交人" min-width="160" sortable>
			</el-table-column>
			<el-table-column  prop='processed' label="设备状态" min-width="150" sortable>
		...
		<el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
				<el-form-item label="矛盾描述" prop="contradictionDes">
					<el-input type="textarea" v-model="editForm.contradictionDes":disabled="true"></el-input>
					
				</el-form-item>
				<el-form-item label="当事人姓名" prop="litigantName">
					<el-input v-model="editForm.litigantName" auto-complete="off" :disabled="true"></el-input>
				</el-form-item>
				<el-form-item label="当事人电话" prop="litigantPhone">
					<el-input v-model="editForm.litigantPhone" auto-complete="off" :disabled="true"></el-input>
				</el-form-item>
			<el-form-item label="矛盾处理">
       ...
       // places: [{label:'南京分行',value:'南京分行'},{label:'上海分行',value:'上海分行'}],//按区域	
        filters: {
        	    state:'',
				 ...
				 states:[{label:'状态 一',value:'状态一'},{label:'状态二',value:'状态二'},{label:'状态三',value:'状态 三'}],
				 banks:[{label:'银行 一',value:'银行一'},{label:'银行二',value:'银行二'},{label:'银行三',value:'银行三'}],
				 regions:[{label:'区域 一',value:'区域一'},{label:'区域二',value:'区域二'},{label:'区域三',value:'区域三'}],
				 types:[{label:'类型 一',value:'类型一'},{label:'类型二',value:'类型二'},{label:'类型三',value:'类型三'}],
				users: [],
				total: 0,
				page: 1,
				listLoading: false,
				...
				editForm: {
					...
					birth: '',
					addr: '',
				contradictionDes:'',//矛盾描述
				litigantName:'',//当事人姓名
				litigantPhone:'',//当事人电话
				contradictionHand:'',//矛盾处理
				processed:'',//处理状态
				untreated:'',//未处理
				submitPerson:'',//提交人
			...
			getUsers() {
				let para = {
					...
					state:this.filters.states,//获取状态
					bank:this.filters.banks,//获取银行
					type:this.filters.types//获取类型
				};
				console.log('hello1');
